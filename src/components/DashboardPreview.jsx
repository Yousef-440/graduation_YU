      ...
      <div className="container">
        <div className="row align-items-center g-5">
          <div className="col-lg-5">
            ...
            <p
              className="mb-4"
              style={{ color: '#8892b0', fontSize: '0.98rem', lineHeight: 1.75 }}
            >
            ...
            <ul className="list-unstyled mb-4">
              {[
                { icon: 'bi-check-circle-fill', text: 'Live shipment map with route visualization', color: '#00ff78' },
                ...
                <li key={text} className="d-flex align-items-center gap-2 mb-2">
                  ...
                  <span style={{ color: '#ccd6f6', fontSize: '0.92rem' }}>{text}</span>
                </li>
              ))}
            </ul>
            ...
            >
              <div
                style={{
                  ...
                  boxShadow: '0 0 60px rgba(0,100,255,0.22), 0 0 100px rgba(0,255,120,0.06)',
              ...
              >
                ...
                >
                  ...
                  <span
                    ...
                    style={{ background: '#00ff78', color: '#000', fontSize: 10, fontWeight: 700 }}
                  >
                    LIVE
                  </span>
                </div>
                ...
                <div className="p-3">
                  ...
                  >
                    {[...Array(7)].map((_, i) => (
                      <div key={`h${i}`} style={{ position: 'absolute', left: 0, right: 0, top: `${(i + 1) * 13}%`, height: 1, background: 'rgba(0,100,255,0.1)' }} />
                    ))}
                    {[...Array(10)].map((_, i) => (
                      <div key={`v${i}`} style={{ position: 'absolute', top: 0, bottom: 0, left: `${(i + 1) * 9}%`, width: 1, background: 'rgba(0,100,255,0.1)' }} />
                    ))}
                    <svg style={{ position: 'absolute', inset: 0, width: '100%', height: '100%' }}>
                      <polyline points="40,160 110,110 195,130 285,80 370,100 460,65 540,85" fill="none" stroke="rgba(0,255,120,0.5)" strokeWidth="2" strokeDasharray="6 3" />
                    </svg>
                    {[
                      { x: '10%', y: '78%', c: '#00ff78' },
                      { x: '30%', y: '54%', c: '#00c6ff' },
                  ...
                  <div className="row g-2 mb-2">
                    {[
                      ...
                      { label: 'Delivery Rate', value: '92%', sub: 'This Month', c: '#00ff78' },
                      ...
                      <div key={label} className="col-3">
                        <div className="text-center p-2 rounded-3" style={{ background: 'rgba(255,255,255,0.04)', border: `1px solid ${c}30` }}>
                          <div style={{ fontSize: 9, color: '#8892b0', textTransform: 'uppercase', marginBottom: 2 }}>{label}</div>
              ...
              >
                <div className="px-3 py-2" style={{ borderBottom: '1px solid rgba(255,255,255,0.06)', background: 'rgba(255,255,255,0.03)' }}>
                  <span style={{ color: '#8892b0', fontSize: 10 }}>SUPPLIER PERFORMANCE</span>
                </div>
                <div className="p-3">
                  {[
                    { name: 'Supplier A', pct: 94, color: '#00ff78' },
                    { name: 'Supplier B', pct: 78, color: '#00c6ff' },
                    { name: 'Supplier C', pct: 61, color: '#ff9900' },
                  ].map(({ name, pct, color }) => (
                    <div key={name} className="mb-2">
                      <div className="d-flex justify-content-between mb-1">
                        <span style={{ color: '#ccd6f6', fontSize: 11 }}>{name}</span>
